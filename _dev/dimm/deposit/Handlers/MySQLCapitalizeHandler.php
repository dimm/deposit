 ...
 * Класс обновляет сумму депозита после рассчета процентов
 */
class MySQLCapitalizeHandler implements IObserverable
{
    ...
    public function afterCalculated(IObserver $subject)
    {
        $this->store(
            ...
            $subject->getCalculatedValue() + $subject->getDeposit()->getAmount()->value
        );
    }
